<template>
  <div class="trace-container">
    ...
    <el-button type="success" plain @click="AllFruitInfo"> 获取所有商品信息 </el-button>
    <el-table
      :data="tracedata"
      style="width: 100%"
    >
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <div><span class="trace-text" style="color: #67C23A;">商品信息</span></div>
            ...
            <div><span class="trace-text" style="color: #409EFF;">批发商信息</span></div>
            <el-form-item label="商品名称：">
