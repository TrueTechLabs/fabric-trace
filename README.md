>  本项目所有相关文档包括区块链设计、后端设计、前端设计、二次开发与结合IPFS改进以及简易的二次开发步骤收录于：[《Fabric项目学习笔记》](https://blog.csdn.net/qq_41575489/article/details/128637560)。
...
#### 一、项目介绍
基于区块链Hyperledger FabricV2.5的农产品溯源/商品/通用溯源应用模板，部署简单，附压测工具tape、区块链浏览器，文档详细。可以快速使用本系统搭建自己的溯源系统，帮助想法快速落地。
...
2. （付费）本系统的讲解课程（约2小时）、Fabric V2.5应用的课程（约10小时），将在B站上架，敬请关注！ 已订阅[《Fabric项目学习笔记 》](https://blog.csdn.net/qq_41575489/category_12075943.html)专栏的用户将获得优惠。
