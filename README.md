...
#### 给项目点上Star，加入TrueTechLabs Fabric学习交流QQ群：776873343
群内包含此项目的区块链部分、应用后端部分的代码说明文档，项目二次开发以及添加IPFS上传文件功能文档收录在专栏：[《Fabric项目学习笔记》](https://blog.csdn.net/qq_41575489/article/details/128637560)。
